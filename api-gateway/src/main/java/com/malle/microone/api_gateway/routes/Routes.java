package com.malle.microone.api_gateway.routes;
...
public class Routes {
    ...
    @Bean(name = "productGatewayRoutes")
    ...
    @Bean(name = "productGatewaySwaggerRoutes")
    ...
    @Bean(name = "orderGatewaySwaggerRoutes")
    ...
    @Bean(name = "inventoryGatewayRoutes")
    ...
    @Bean(name = "inventoryGatewaySwaggerRoutes")
